             ...
             konsolda yazdirin.
{
    ...
    public void jsonObje02(){
        ...
        JSONObject bookıngDates =new JSONObject();

        bookıngDates.put("checkin","2018-01-01");
        bookıngDates.put("checkout","2019-01-01");
        ...
        outerJson.put("bookingdates",bookıngDates);

        System.out.println("Boobkıng Json Obje " +outerJson);
